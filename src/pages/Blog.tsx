    ...
    <main>
      <SEOHead
        ...
        additionalSchemas={[{
          ...
          "url": "https://trackmytrain.com.pk/blog",
          "publisher": { "@type": "Organization", "name": "Track My Train", "url": "https://trackmytrain.com.pk" },
          "blogPost": blogPosts.map((p) => ({
            "@type": "BlogPosting",
            "headline": p.title,
            "url": `https://trackmytrain.com.pk/blog/${p.slug}`,
