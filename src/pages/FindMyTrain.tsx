      ...
      <div className="container mx-auto px-4 py-8 sm:py-12">
        ...
        <section className="mb-12 sm:mb-16 max-w-4xl mx-auto">
          ...
          <div className="prose prose-sm max-w-none text-muted-foreground space-y-5">
            <p className="text-base leading-relaxed">Find My Train is an innovative GPS-based feature exclusively available on TrackMyTrain.com.pk that allows Pakistan Railways passengers to <strong>automatically identify which train they are traveling on</strong>. Using the Haversine formula for distance calculation and real-time GPS coordinates from both the user's device and our train tracking network, the system can identify a passenger's train within seconds — no manual searching required.</p>
