...
export default function TrainDetailPage() {
  ...
  const trainFaqs = [
    ...
    { q: `Is ${train.name} running today?`, a: `${train.name} ${train.number} runs on: ${train.days.join(", ")}. It is currently ${train.status === "active" ? "active and operational" : "inactive/suspended"}. Use TrackMyTrain.com.pk's live tracker to check the real-time status and position.` },
