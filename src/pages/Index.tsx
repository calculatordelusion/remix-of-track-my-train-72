...
export default function HomePage() {
  ...
  const faqs = [
    ...
    { q: "Do I need to download an app or create an account?", a: "No — Track My Train works entirely in your browser. Open trackmytrain.com.pk on any phone, tablet, or computer and start tracking instantly. There's no app to install, no account to create, and no personal information collected. The site is lightweight and optimized to load fast even on 2G or 3G mobile data, so you can check your train anywhere in Pakistan." },
          ...
          <div className="grid lg:grid-cols-[1fr_auto] gap-8 lg:gap-12 items-center">
            <div className="max-w-3xl">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-6 leading-[1.05] tracking-tight text-[hsl(var(--hero-text))]">
                ...
                <span className="block mt-1"><span className="text-gradient-gold">Live Train Tracking</span></span>
                <span className="block mt-1 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-[hsl(var(--hero-text-muted))]">Pakistan Railways GPS Tracker</span>
              </h1>
