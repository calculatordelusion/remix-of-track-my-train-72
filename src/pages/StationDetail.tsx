...
export default function StationDetailPage() {
  ...
  const stationFaqs = [
    ...
    { q: `Can I track trains arriving at ${station.name} in real-time?`, a: `Yes! You can track all trains arriving at or departing from ${station.name} in real-time using TrackMyTrain.com.pk's live GPS tracker. Simply visit the Live Trains page, find your train, and see its exact position, speed, and estimated arrival time at ${station.name}.` },
