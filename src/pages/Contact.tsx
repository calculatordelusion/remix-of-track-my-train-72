...
const contactFaqs = [
  ...
  { q: "Does TrackMyTrain.com.pk have social media accounts?", a: "Currently, TrackMyTrain.com.pk operates primarily through our website. We focus all our development energy on improving the tracking platform itself. For updates and announcements, check our blog at trackmytrain.com.pk/blog." },
  { q: "Can I partner with TrackMyTrain.com.pk or advertise on the platform?", a: "We're open to partnerships that benefit Pakistani railway travelers. For partnership inquiries, please use the contact form with the subject 'Other Inquiry' and describe your proposal. We evaluate all partnership requests based on how they can improve the experience for our users." },
  ...
  { q: "Can I contribute to TrackMyTrain.com.pk as a developer?", a: "We appreciate the enthusiasm! If you're a developer interested in contributing to Pakistan's railway technology ecosystem, please reach out via the contact form with the subject 'Other Inquiry'. Describe your skills, experience, and how you'd like to contribute." },
  { q: "Why doesn't TrackMyTrain.com.pk sell tickets?", a: "TrackMyTrain.com.pk is an information and tracking platform, not a ticketing service. Ticket sales are managed exclusively by Pakistan Railways through their official channels, the 117 helpline, and authorized booking offices at stations. We focus on what we do best: providing accurate, real-time tracking and schedule information." },
  { q: "How do I get notifications about train delays?", a: "Currently, TrackMyTrain.com.pk provides real-time delay information that you can check on-demand through our Check Delays tool or individual train detail pages. We're exploring push notification functionality as a future feature based on community demand." },
          ...
          <div className="lg:col-span-2 space-y-4">
            <Card className="gradient-card-emerald border">
              <CardContent className="p-5">
                ...
                <h3 className="font-bold text-sm mb-1">About TrackMyTrain.com.pk</h3>
