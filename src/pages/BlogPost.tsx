...
export default function BlogPostPage() {
  ...
  const articleSchema = {
    ...
    "image": `https://trackmytrain.com.pk${post.image}`,
    "datePublished": post.dateISO,
    "dateModified": post.dateISO,
    "author": { "@type": "Organization", "name": "Track My Train", "url": "https://trackmytrain.com.pk" },
    "publisher": {
      "@type": "Organization",
      "name": "Track My Train",
      "url": "https://trackmytrain.com.pk",
      "logo": { "@type": "ImageObject", "url": "https://trackmytrain.com.pk/og-image.png" },
    },
    "mainEntityOfPage": { "@type": "WebPage", "@id": `https://trackmytrain.com.pk/blog/${post.slug}` },
