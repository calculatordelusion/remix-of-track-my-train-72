...
// Major railway corridors based on official Pakistan Railways data
    ...
    <main>
      <SEOHead
        ...
        additionalSchemas={[{
          ...
          "url": "https://trackmytrain.com.pk/train-routes",
      ...
      >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-8">
          {[
            { value: stats.running || stats.liveCount || stats.moving, label: "Moving Now", color: "text-emerald-600 dark:text-emerald-400" },
            { value: stats.atStation, label: "At Stations", color: "text-amber-600 dark:text-amber-400" },
            { value: stats.total, label: "Total Trains", color: "text-blue-600 dark:text-blue-400" },
            { value: stations.length, label: "Stations", color: "text-purple-600 dark:text-purple-400" },
          ].map((s, i) => (
